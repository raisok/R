pdf("/ldfssz1/ST_BIGDATA/USER/yueyao/12.Pro/test/result/process/GeneDiffExp_Allin/DEseq2/R6_12h-VS-R6_24h.DEseq2_Method.Volcano-plot.pdf",width=12,height=10,pointsize=15)
data <- read.table("/ldfssz1/ST_BIGDATA/USER/yueyao/12.Pro/test/result/process/GeneDiffExp_Allin/DEseq2/R6_12h-VS-R6_24h.DEseq2_Method.prepare4Volcano-plot", sep = "\t", skip = 1)
...
plot(0,0,pch="",xlim=c(xmin,xmax),ylim=c(ymin,ymax),ylab="-log10(Padj)",xlab="log2(fold change)",cex.lab = 1.5,main="Volcano plot for R6_12h-VS-R6_24h.DEseq2_Method",cex=1.5)
